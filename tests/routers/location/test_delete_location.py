...
def test_delete_location(_):  # noqa: F811:
    """
...
def test_delete_location_not_authenticated(_):  # noqa: F811:
    """
    Test deleting location when not authenticated.

    This test tries to delete location when user is
    not authenticated, so API should return error message.
    """
    user_data = {
        "username": "test_user",
        "email": "test_user@test.example",
...
def test_delete_location_missing_field(_):  # noqa: F811:
    """
    Test deleting location when missing field

    This test tries to delete location with missing
    field, so API should return error message.
    """
    user_data = {
        "username": "test_user",
        "email": "test_user@test.example",
